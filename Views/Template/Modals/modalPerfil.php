            ...
            <form id="formPerfil" name="formPerfil" class="form-horizontal">
              ...
              <div class="form-row">
                <div class="form-group col-md-6">
                    ...
                    <input type="text" class="form-control valid validNumber" id="txtDni" name="txtDni" value="<?= $_SESSION['userData']['dni']; ?>" required=""  >
                </div>
                <div class="form-group col-md-6">
                    <label for="txtDireccion">Direccion<span class="required">*</span></label>
                    <input type="text" class="form-control valid validtext" id="txtDireccion" name="txtDireccion" value="<?= $_SESSION['userData']['direccion']; ?>" required=""  >
                </div>
              </div>
              <div class="form-row">
                <div class="form-group col-md-6">
